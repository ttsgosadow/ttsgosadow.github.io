            ...
            function generateGame( targetField ) {
              ...
              else
              {
                ...
                var generatedGame = '<div class="alert alert-success" role="alert"><strong>Succes!</strong> The fickle winds of fate yielded these flips for deployment, strategy and schemes.</div>' + 
                    ...
                    '<p><strong>Strategy:</strong> ' + strategy[0] + ' (' + cardImage(strategyCard) + ')<input type="checkbox" class="pull-right" id="strategy-text-cb" '+checkedState+' onclick="togglediv(\'strategy-text\')"><div class="small" id="strategy-text">' + strategy[1] + '</div></p>' +
                    '<p><strong>Schemes:</strong> (' + cardImage(schemeCard1) + ',' + cardImage(schemeCard2) + ')<ul>' +
                    '<li>' + schemes[0][1] + ' (' + suitImage(schemes[0][0]) + ')<input type="checkbox" class="pull-right" id="scheme1-text-cb" '+checkedState+' onclick="togglediv(\'scheme1-text\')"><div class="small" id="scheme1-text">' + schemes[0][2] + '</div></li>' +
