function getPlayers()
{
   ...
   [ "Jim - Guild" , [13,6], [8,1] , [11,1] ],
   [ "Kasper - Ten Thunders" , ['r',3] , ['r',3] , ['c',2] , [6,1] , [9,3] , [13,7] ],
   [ "Patrick - Ten Thunders" , ['c',5] , ['c',4] , ['r',2] , [3,3] ],
...
function getRanking()
{
   var lastUpdated = "August 25, 2017"
...
var events = {
  ...
  imbalance: ["An Evil Imbalance", 6, "\"Nothing is fair in love and war\" - Unknown", "If you have fewer cards in your hand than your opponent, you gain +flip on all opposing Duels targetting an opposing model.<br /><br />After killing an enemy model draw a card.", '<img src="" />'],
