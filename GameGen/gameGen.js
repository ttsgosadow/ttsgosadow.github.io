            ...
            function generateGame( targetField ) {
              ...
              else
              {
                ...
                var generatedGame = '<div class="alert alert-success" role="alert"><strong>Success!</strong> The fickle winds of fate yielded these flips for deployment, strategy and schemes.</div>' + 
                    ...
                    '<div class="modal-footer"><button type="button" class="btn btn-primary btn-clipboard" onClick="new Clipboard(\'.btn-clipboard\');this.value=\'Copied\';" data-clipboard-target="#visible-input">Copy to clipboard</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div>' +
