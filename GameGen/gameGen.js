...
function getStrategy( suit, value, gameType ) 
{
  ...
  {
    var strategy = {
      bj: ["Supply Wagons", "Before either player deploys models, starting with the second player, each player places one 50mm, Ht 3, Blocking, Impassable, Hard Cover friendly Supply Wagon Marker on their side of the table, anywhere completely in their deployment zone and not in terrain.<br /><em>Special</em><br />Non-Peon models in base contact with a Supply Wagon Marker may take a (1) Interact Action to push the Marker in any direction, ignoring intervening models.<br />If this Marker would come into base contact with impassable terrain, it stops in base contact with the terrain, if that terrain was a Terrain Marker, remove that marker and then continue the push as normal. Supply Wagon Markers cannot end a push on a models base.<br />The distance of the push depends on the model’s base size:<br />• 30mm: Up to 2\"<br />• 40mm: Up to 3\"<br />• 50mm: Up to 4\"<br /><em>Victory Points</em><br />At the end of every Turn after the first, a Crew earns 1 VP if they have a friendly Supply Wagon at least partially on their opponent's side of the board."],
      rj: ["Supply Wagons", "Before either player deploys models, starting with the second player, each player places one 50mm, Ht 3, Blocking, Impassable, Hard Cover friendly Supply Wagon Marker on their side of the table, anywhere completely in their deployment zone and not in terrain.<br /><em>Special</em><br />Non-Peon models in base contact with a Supply Wagon Marker may take a (1) Interact Action to push the Marker in any direction, ignoring intervening models.<br />If this Marker would come into base contact with impassable terrain, it stops in base contact with the terrain, if that terrain was a Terrain Marker, remove that marker and then continue the push as normal. Supply Wagon Markers cannot end a push on a models base.<br />The distance of the push depends on the model’s base size:<br />• 30mm: Up to 2\"<br />• 40mm: Up to 3\"<br />• 50mm: Up to 4\"<br /><em>Victory Points</em><br />At the end of every Turn after the first, a Crew earns 1 VP if they have a friendly Supply Wagon at least partially on their opponent's side of the board."],
      c: ["Ours", "Divide the table into four 18\" by 18\" table Quarters.<br /><em>Victory Points</em><br />At the end of every Turn after the first, add up the Soulstone cost of all friendly non-Peon models in each table Quarter, not counting any models that: were summoned this game, are within any other table Quarters, or are within 6\" of the Center of the table. The Crew with the highest Soulstone cost within each table Quarter controls it. For this Strategy, Masters and non-Master models with a cost of 0 count as having a cost of 10.<br />If a Crew controls at least two table Quarters, that Crew earns 1 VP."],
      m: ["Symbols of Authority", "Before either player deploys models, starting with the second player, each player places three 50mm, Ht 5, Blocking, Impassable, Hard Cover Strategy Markers fully on their side of the table, not in their deployment zone, and at least 10\" from another Strategy Marker on their side of the table. These markers cannot be placed in base contact with impassable terrain.<br /><em>Special</em><br />On any Turn after the first, non-Peon models may take a (1) Interact Action targeting a Strategy Marker within 1\" on their opponent's side of the board to remove it from play.<br /><em>Victory Points</em><br />At the end of every Turn after the first, a Crew earns 1 VP if it removed one or more Strategy Markers this Turn.<br />At the end of the game, a Crew earns 1 VP if they have any Strategy Markers on their side of the table."],
      r: ["Ply for Information", "On any Turn after the first, non-Peon models may take a (1) Interact Action targeting an enemy model they are engaged with that does not have the Gathered Intel Condition to gain the following Condition until the end of the game:<br />Gathered Intel: This Condition is removed if this model suffers Severe damage.<br />This Condition cannot be gained in any way other than as is stated in this Strategy.<br /><en>Victory Points</em><br />At the end of every Turn after the first, if a Crew has more models in play with the Gathered Intel Condition than the opposing crew, that Crew earns 1 VP. Then remove the Gathered Intel Condition from every model in play."],
      t: ["Public Executions", "On any Turn after the first, whenever a non-Peon model kills or sacrifices a non-Peon model it considers an enemy, it gains the following Condition until the end of the game:<br />Shed Blood: At the end of this model's Activation, remove this condition if no enemy models have line of sight to this model.<br />This Condition cannot be gained in any way other than as is stated in this Strategy.<br /><em>Victory Points</em><br />At the end of every Turn after the first, if a Crew has more models in play with the Shed Blood Condition than the opposing crew, that Crew earns 1 VP. Then remove the Shed Blood Condition from every model in play."]
    }
  }
...
{
   var schemes = {
      bj: ["BJ", "Guarded Treasure", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />At the end of every Turn after the first, this Crew earns 1 VP if it has at least two Scheme Markers within 2\" of the Centerline, at least 8\" apart, and each has at least 1 friendly non-Peon, non-Minion model within 3\". After scoring, remove all friendly Scheme Markers within 2\" of the Centerline."],
      rj: ["RJ", "Guarded Treasure", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />At the end of every Turn after the first, this Crew earns 1 VP if it has at least two Scheme Markers within 2\" of the Centerline, at least 8\" apart, and each has at least 1 friendly non-Peon, non-Minion model within 3\". After scoring, remove all friendly Scheme Markers within 2\" of the Centerline."],
      c: ["c", "Guarded Treasure", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />At the end of every Turn after the first, this Crew earns 1 VP if it has at least two Scheme Markers within 2\" of the Centerline, at least 8\" apart, and each has at least 1 friendly non-Peon, non-Minion model within 3\". After scoring, remove all friendly Scheme Markers within 2\" of the Centerline."],
      m: ["m", "Punish the Weak", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />At the end of every Turn after the first, if at least one enemy Minion or Peon model was killed by one of this Crew's Henchman or Master models, this Crew earns 1 VP.<br />At the end of every Turn after the first, if the opposing Crew has no Minion or Peon models in play outside of their own Deployment Zone, this Crew earns 1 VP.<br />No more than 1 VP per Turn may be earned from this Scheme."],
      ...
      4: [4, "Hold Up Their Forces", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />At the end of every Turn after the first, this Crew earns 1 VP if at least one of its non-Peon models is engaged with at least two enemy models with no other friendly models engaging them."],
      ...
      6: [6, "Inescapable Trap", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />At the end of every Turn after the first, this Crew earns 1 VP if two or more enemy non-Peon models are within 3\" of one or more Scheme Markers friendly to this Crew.<br />Then, remove one qualifying Scheme Marker."],
...
"],
      8: [8, "Search The Ruins", "This Scheme may not start revealed.<br /> At the end of the game, this Crew earns 2 VP if it has 3 or more Scheme Markers within 6\" of the Center of the board and not within 2\" of other friendly Scheme Markers.<br />If at least two qualifying Scheme Markers are on the opponent’s half of the table, earn 1 additional VP."],
      9: [9, "Take Prisoner", "This Scheme may not start revealed.<br /> When you choose this Scheme, note down an enemy model. At the end of the game, if this Crew has at least one non-Peon model engaged with the noted enemy model, this Crew earns 2 VP.<br />If this Crew earns any VP from this Scheme and there are no other enemy models within 3\" of the noted model, this Crew earns 1 additional VP."],
      10: [10, "Take One For the Team", "This Scheme may not start revealed. Reveal this Scheme once this Crew has earned any VP from it.<br />When you choose this Scheme, note one of this Crew’s non-Peon, non-Leader models as the \"sucker.\" If the chosen \"sucker\" model is killed or sacrificed by an enemy model, this Crew earns 1 VP.<br />If the enemy model has a higher Soulstone cost than the \"sucker\" or was a Master, this Crew earns 1 additional VP. Some Henchman Models have a Soulstone cost of 0, these models count as having a cost of 13 minus their Cache.<br />If this Scheme was revealed on or after Turn 4, this Crew earns 1 additional VP."],
      11: [11, "Recover Evidence", "This Scheme may not start revealed. You may reveal this Scheme at the beginning of any Turn. After revealing this Scheme, the opponent chooses five of their models in play (or all of their models in play if they have less than five remaining).<br />Place an enemy Evidence Marker in base contact with the models chosen by the opponent.<br />Models in this Crew may use a (1) Interact Action to remove an enemy Evidence Marker in base contact with itself. If they do, this Crew earns 1 VP."],
      12: [12, "Vendetta", "This Scheme may not start revealed. Reveal this Scheme once this Crew has scored any VP from it.<br />The scheming player notes one of their non-Leader, non-Peon models with a Soulstone cost greater than 0 and an enemy model with a Soulstone cost equal to or greater than the scheming player's chosen model.<br />If the noted friendly model's first Attack Action in the game is against the noted enemy model, score 1 VP and reveal this Scheme.<br />If the noted enemy model is not in play at the end of the game, and this Scheme has been revealed, score 1 additional VP.<br />If the noted enemy model is killed by the chosen friendly model, score 3 VP."],
      13: [13, "Public Demonstration", "This Scheme may not start revealed.<br />When you choose this Scheme, note down up to three Minion models in this Crew with a combined Soulstone Cost of at least 15.<br />Once per game, at the end of any Turn, this Crew may reveal this Scheme to earn 1 VP for each of the noted models within 4\" and LoS of an enemy Master, Henchman, or Enforcer."]
   }
