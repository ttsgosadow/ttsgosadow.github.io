            ...
            function generateGame( targetField ) {
              ...
              else
              {
                ...
                var generatedGame = '<div class="alert alert-success" role="alert"><strong>Success!</strong> The fickle winds of fate yielded these flips for deployment, strategy and schemes.</div>' + 
                    ...
                    '<li>' + schemes[1][1] + ' (' + suitImage(schemes[1][0]) + ')<input type="checkbox" class="pull-right" id="scheme2-text-cb" '+checkedState+' onclick="togglediv(\'scheme2-text\')"><blockquote class="small" id="scheme2-text">' + schemes[1][2] + '</blockquote></li>' +
                    '<li>' + schemes[2][1] + ' (' + suitImage(schemes[2][0]) + ')<input type="checkbox" class="pull-right" id="scheme3-text-cb" '+checkedState+' onclick="togglediv(\'scheme3-text\')"><blockquote class="small" id="scheme3-text">' + schemes[2][2] + '</blockquote></li>' +
                    '<li>' + schemes[3][1] + ' (' + suitImage(schemes[3][0]) + ')<input type="checkbox" class="pull-right" id="scheme4-text-cb" '+checkedState+' onclick="togglediv(\'scheme4-text\')"><blockquote class="small" id="scheme4-text">' + schemes[3][2] + '</blockquote></li>' +
                    '<li>' + schemes[4][1] + ' (' + suitImage(schemes[4][0]) + ')<input type="checkbox" class="pull-right" id="scheme5-text-cb" '+checkedState+' onclick="togglediv(\'scheme5-text\')"><blockquote class="small" id="scheme5-text">' + schemes[4][2] + '</blockquote></li>' +
                    '</ul></p>' +
                    '</div></div>'
                }
