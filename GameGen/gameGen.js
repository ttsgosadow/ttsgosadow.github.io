...
function getStrategy( suit, value, gameType ) 
{
  ...
  {
    var strategy = {
      bj: ["Supply Wagons", "Before either player deploys models, starting with the second player, each player places one 50mm, Ht 3, Blocking, Impassable friendly Supply Wagon Marker on their side of the table, anywhere where it is completely in their deployment zone.<br /><em>Special</em>Non-Peon models in base contact with a Supply Wagon Marker may take a (1) Interact Action to push the Marker in any direction, ignoring intervening models.<br />If this Marker would come into base contact with impassable terrain, it stops in base contact with the terrain, if that terrain was a non-Supply Wagon Terrain Marker, remove that marker and then continue the push as normal. Supply Wagon Markers cannot end a push on a models base. The distance of the push depends on the model’s base size:<br />• 30mm: Up to 2"\"<br />• 40mm: Up to 3\"<br />• 50mm: Up to 4\"<br /><em>Victory Points</em>At the end of every Turn after the first, a Crew earns 1 VP if they have a friendly Supply Wagon at least partially on their opponent's side of the board."],
